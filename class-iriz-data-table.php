...
if ( ! class_exists( 'Iriz_Data_API' ) ) {
	require_once plugin_dir_path( __FILE__ ) . 'class-iriz-data-api.php';
}

/**
 * Data table plugin base class.
 */
class Iriz_Data_Table {
	...
	/**
	 * Constructor
	 * Initialization and configuration of tables.
	 */
	...
	public function save_form_submission() {
		...
		$nonce = isset( $_POST['iriz_data_nonce'] ) ? sanitize_key( $_POST['iriz_data_nonce'] ) : '';
		if ( empty( $nonce ) || ! wp_verify_nonce( $nonce, 'iriz_data_nonce' ) ) {
